...
public class EventModelCentrosApiPública {
    ...
    public EventModelCentrosApiPública(String nombreCentro, String Localizaconi, String tipoEducacion, String tipoAccesibilidad, String id) {
