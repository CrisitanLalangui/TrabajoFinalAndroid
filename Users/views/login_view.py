...
class LoginView(APIView):
    ...
    def post(self,request):#se usa un método post, para enviar información, y porque la contraseña va encriptada.
        ...
        return Response({"succcess":False, "errors":errores}, status=status.HTTP_400_BAD_REQUEST) #Envia una resupesta en formato JsIN

           #Asigna una señal de error 400 bad request